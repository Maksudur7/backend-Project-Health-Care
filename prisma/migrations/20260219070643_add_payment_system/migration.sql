/*
  ...
  - Made the column `isDeleted` on table `patient` required. This step will fail if there are existing NULL values in that column.
...
-- DropIndex
DROP INDEX "doctor_specialties_id_key";
